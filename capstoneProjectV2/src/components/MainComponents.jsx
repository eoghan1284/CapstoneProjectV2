...
const MainComponents = ({ gender, setGender, probs, playerGold, setPlayerGold, total1, setTotal1, total2, setTotal2, total3, setTotal3, choices, setChoices, results, setResults, onFinished}) => {
